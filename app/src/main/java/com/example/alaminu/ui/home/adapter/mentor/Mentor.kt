package com.example.alaminu.ui.home.adapter.mentor
...
class Mentor: RecyclerView.Adapter<Mentor.MyViewHolder>() {
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(mapel: Map<String, String>) {
            val textView: TextView = itemView.findViewById(R.id.mentor)
            ...
            if (!imagePath.isNullOrBlank()) {
                ...
                imageView.setImageResource(R.drawable.mentora)
            }
        }
    }
}