...
object DbContract {
    const val ip = "192.168.76.208"
    const val urlLogin = "http://$ip/alaminu_api/api-login.php"
    const val urlRecymapel = "http://$ip/alaminu_api/recy-mapel.php"
    const val urlRecymentor = "http://$ip/alaminu_api/recy-mentor.php"
    ...
    const val urlAbsener = "http://$ip/alaminu_api/absener.php"
}
